...
(cd my-empty-wasm && ./build-deterministic.sh)
...
cp my-empty-wasm/checksums/hashes.txt "$WASM_ORIGINAL_HASHES" 2>/dev/null || echo "No existing WASM hashes found"
...
WASM_REBUILD_HASHES="my-empty-wasm/checksums/hashes.txt"
